...
Ubuntu & Debian based distributions can now install the [Debian package](https://github.com/LinxGem33/OSX-Arc-Shadow/releases) for easier installation of the theme all deb files have checksums for file integrity.
